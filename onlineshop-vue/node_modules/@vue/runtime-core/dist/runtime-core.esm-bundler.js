...
function prepareTransitionLeave(previous, enterHooks, props, state, instance, resumeAfterLeave) {
	...
	if (!previousInner || previousInner.type === Comment || previous.component && recursiveGetSubtree(previous.component).type === Comment) return false;
