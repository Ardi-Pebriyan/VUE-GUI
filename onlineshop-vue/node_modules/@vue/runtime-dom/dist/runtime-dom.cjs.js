...
var VueElementBase = class VueElementBase extends BaseClass {
	...
	*/
	...
	_resolveProps(def) {
		...
		for (const key of declaredPropKeys.map(_vue_shared.camelize)) {
			if (key in Object.getPrototypeOf(this)) (0, _vue_runtime_core.warn)(`Custom element prop "${key}" conflicts with an existing property on the element and will overwrite it.`);
