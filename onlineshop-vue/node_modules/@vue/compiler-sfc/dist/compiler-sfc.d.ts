...
//#endregion
//#region temp/packages/compiler-sfc/src/compileTemplate.d.ts
export interface TemplateCompiler {
  compile(source: string | RootNode, options: CompilerOptions$2): BaseCodegenResult;
...
export interface SFCParseResult {
  ...
  errors: (CompilerError$1 | SyntaxError)[];
}
export declare function parse(source: string, options?: SFCParseOptions): SFCParseResult;
//#endregion
//#region temp/packages/compiler-sfc/src/style/preprocessors.d.ts
type PreprocessLang = "less" | "sass" | "scss" | "styl" | "stylus";
//#endregion
//#region temp/packages/compiler-sfc/src/compileStyle.d.ts
...
*/
export declare function rewriteDefaultAST(ast: Statement$1[], s: MagicString$1, as: string): void;
//#endregion
...
//#endregion
//#region temp/packages/compiler-sfc/src/script/defineModel.d.ts
interface ModelDecl {
  type: TSType | undefined;
  options: string | undefined;
  identifier: string | undefined;
  runtimeOptionNodes: Node$1[];
}
//#endregion
...
//#endregion
//#region temp/packages/compiler-sfc/src/script/context.d.ts
export declare class ScriptCompileContext {
  ...
  emitDecl: Node$1 | undefined;
  modelDecls: Record<string, ModelDecl>;
  optionsRuntimeDecl: Node$1 | undefined;
  bindingMetadata: BindingMetadata$2;
  ...
  */
  ...
  warn(msg: string, node: Node$1, scope?: TypeScope): void;
...
*/
export declare function resolveTypeElements(ctx: TypeResolveContext, node: Node$1 & MaybeWithScope & {
  _resolvedElements?: ResolvedElements;
}, scope?: TypeScope, typeParameters?: Record<string, Node$1>): ResolvedElements;
/**
* @private
*/
...
export declare function inferRuntimeType(ctx: TypeResolveContext, node: Node$1 & MaybeWithScope, scope?: TypeScope, isKeyOf?: boolean, typeParameters?: Record<string, Node$1>): string[];
//#endregion
//#region temp/packages/compiler-sfc/src/script/defineEmits.d.ts
export declare function extractRuntimeEmits(ctx: TypeResolveContext): Set<string>;
//#endregion
//#region temp/packages/compiler-sfc/src/index.d.ts
...
//#endregion
export { type BindingMetadata, type CompilerError, type CompilerOptions$1 as CompilerOptions, MagicString, babelParse, extractIdentifiers, generateCodeFrame, isInDestructureAssignment, isStaticProperty, walkIdentifiers };